...
------:|------:|-----:|------------
`&h00` | 2     | i16  | File Version<br /><table><thead><tr><th>Value<th>Description<tbody><tr><td>1 (≤3)<td>SmileBASIC 3 (Some system files may mistakenly have 0, so it's safer to just include everything 3 and below.)<tr><td>4<td>SmileBASIC 4</table>
...
`&h13` | 1     | i8   | Last mod. date: weekday (0 = Sunday, ... 6 = Saturday)
